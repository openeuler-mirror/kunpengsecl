...
`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Printf("Hi, I'm here! cmd=%v, args=%v", cmd, args)
	},
}
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".tbprovisioner" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigType("yaml")
		viper.SetConfigName(".tbprovisioner")
	}
